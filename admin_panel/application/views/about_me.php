...
$("#add_btn").click(function(){
	...
	if(name.length <= 0){
		...
		$("#name").focus();
		setTimeout(function(){ $("#add_about_me_msg").html("<sapn style='color:white;'>Add about_me</span>"); }, 3500);
...
$("#edit_btn").click(function(){
	...
	if(name.length <= 0){
		...
		$("#edit_name").focus();
		setTimeout(function(){ $("#edit_about_me_msg").html("<sapn style='color:white;'>Edit About Me</span>"); }, 3500);
		...
		$.ajax({
			...
			if(result == 1){
				...
				setTimeout(function(){ $("#edit_about_me_msg").html("<sapn style='color:white;'>Edit about_me</span>"); }, 3500);
			}
		  }
		 });
	}
