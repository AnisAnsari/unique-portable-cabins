...
<head>
  ...
  <title>Sunrise Portable Cabin</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Sunrise Portable Cabin</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>why_choice" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Why Choice
              </p>
    ...
    <!--      </li>-->
		  ...
		  <!--<li class="nav-item">-->
    <!--        <a href="<?php echo base_url();?>result" class="nav-link">-->
    <!--          <i class="nav-icon fas fa-th"></i>-->
    <!--          <p>-->
    <!--            Result -->
    <!--          </p>-->
    ...
    <!--      </li>-->
		  ...
		  <!--<li class="nav-item">-->
    <!--        <a href="<?php echo base_url();?>admission" class="nav-link">-->
    <!--          <i class="nav-icon fas fa-th"></i>-->
    <!--          <p>-->
    <!--            Admission-->
    <!--          </p>-->
