...
class Service extends CI_Controller {
	...
	{
		$columns = array("id","name","description","image","size","shape","feature","built_type","material","is_active");
		$data['event'] = $this->service->getSpecificData($columns,"service",["is_active"=>1]);
...
function get_service_data(){
	...
	$columns = array("id","name","description","image","size","shape","feature","built_type","material");
    $event_data = $this->service->getSpecificData($columns,"service",["is_active"=>1,"id"=>$id]);
...
function delete_service(){
	 ...
	 $columns = array("image");
	 $banner_image = $this->service->getSpecificData($columns,"service",["is_active"=>1,"id"=>$id]);
